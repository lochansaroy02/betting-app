...
const Sponsor = () => {
  ...
  return (
    <div className='flex flex-col bg-orange-950 py-8  items-center gap-4    '>
      ...
      <h1 className='text-orange-50 lg:text-4xl text-2xl font-bold font-kanit'>Our Sponsors</h1>
      <div className='flex flex-col  lg:flex-row w-full  justify-around'>
        {
          arr.map((item) => (
            <div className='flex  justify-center gap-2  flex-col items-center '>
              ...
              <h1 className='lg:text-2xl text-xl  text-orange-100 font-lato'>{item.name}</h1>
            </div>
          ))
        }
      </div>
