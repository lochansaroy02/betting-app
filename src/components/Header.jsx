...
const Header = () => {
    ...
    return (
        <div className='cursor-pointer fixed  top-0 w-full z-10 backdrop-blur-lg   bg-opacity-50 border-b flex  justify-between items-center border-orange-700  bg-orange-950 '>
            <div onClick={() => {
                navigate("/")
